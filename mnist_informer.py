...
file_path = '/app/mnist_theory3/filename'
...
def img_preprocess(img):
    ...
    im.save('/app/mnist_theory3/your_file_image.png')
    # image11 = Image.open('/sysroot/home/user/Загрузки/PyProject/mnist_streamlit/your_file_image.png')
    image11 = Image.open('/app/mnist_theory3/your_file_image.png')
...
with col21:
    with st.container():
        ...
        st.image('/app/mnist_theory3/mnist_example.png')
        #run = st.checkbox('Run')
...
with col22:
    with st.container():
        ...
        if img_file_buffer is not None:
            ...
            model_2d = load_model('/app/mnist_theory3/mnist_2d_conv.h5')
